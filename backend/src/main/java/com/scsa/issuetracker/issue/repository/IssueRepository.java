...
public interface IssueRepository extends JpaRepository<Issue, Long> {
    ...
    Page<Issue> findByProjectIdAndStatus(Long projectId, IssueStatus status, Pageable pagealbe);
    ...
    Page<Issue> findByProjectIdAndStatusAndIssueTypeAndPriority(Long projectId, IssueStatus status, IssueType issueType, IssuePriority priority, Pageable pageable);
}
